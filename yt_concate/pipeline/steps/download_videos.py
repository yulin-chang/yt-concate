...
class DownloadVideos(Step):
    ...
    def process(self, data, inputs, utils):
        ...
        print('>>download videos: took', end - start, 'seconds')

        return data

    def multi_download_videos(self, yt_set, utils, multi_str):
        for yt in yt_set:  # yt = find.yt
            ...
            print(f'download videos({multi_str}): {yt.url}')
